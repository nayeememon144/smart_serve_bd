...
import { User, Mail, Phone, MapPin, Briefcase, Save, Bell, Shield } from 'lucide-react';
    ...
    return (
        <div className="provider-dashboard-content">
            <header className="dashboard-header">
                <div>
                    <h1>Settings</h1>
                    <p>Manage your account and service preferences</p>
                </div>
            </header>
                    ...
                    <div className="notification-options">
                        <label className="toggle-option">
                            <span>
                                ...
                                <small>Get notified when you receive a new booking</small>
                            </span>
                        ...
                        <label className="toggle-option">
                            <span>
                                ...
                                <small>Get notified when customers request quotes</small>
                            </span>
                            <input type="checkbox" defaultChecked />
                        </label>
                        <label className="toggle-option">
                            <span>
                                ...
                                <small>Get notified when customers review your services</small>
                            </span>
                            <input type="checkbox" defaultChecked />
                        </label>
                        <label className="toggle-option">
                            <span>
                                ...
                                <small>Get reminders about upcoming service appointments</small>
                            </span>
                            <input type="checkbox" defaultChecked />
                        </label>
                    </div>
